...
\begin{itemize}[leftmargin=2.5em, itemsep=-0.25em, topsep=0.5em]\vspace{-0.3em}
    ...
    \item Combine machine learning methods to identify the economic and geoclimatic characteristics driving the heterogeneous treatment effects
\end{itemize}
...
\sectionheading{Professional Experience}
	...
	\begin{position}{Quantitative Research Analyst}{}	
        ...
        \item Developed an interpretable model to nowcast S\&P 500 aggregate earnings per share, reducing out-of-sample mean squared error by 18\% relative to a historical-mean benchmark and achieving 75\% directional accuracy
	\end{position}
